...
we explore it in **DOC 13 — Data Architecture**.

> **Looking back...** You first met the Repository in **DOC 5 — Android Lifecycle & Architecture**, where it was introduced as the data owner in the UDF pipeline. Now you're seeing what the Repository actually coordinates — Remote Data Sources like this one, plus local databases (DOC 12).
