...
> **You'll see this in...**
> - **DOC 11 — Remote Communication**, where you'll learn how data travels from a server API through OkHttp and Retrofit into your app
> - **DOC 12 — Local Persistence**, where Room provides the local cache that makes your app work offline
> - **DOC 13 — Data Architecture**, where the Repository pattern connects networking, caching, and your ViewModel into one coherent data pipeline
> - **DOC 14 — Dependency Injection**, where Hilt wires all these layers together so you don't construct dependencies manually
