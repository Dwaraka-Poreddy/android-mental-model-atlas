...
> **You'll see this in...**
> - **DOC 8 — Inside Compose Runtime**, where you'll learn *how* Compose detects state changes and triggers recomposition at the runtime level
> - **DOC 9 — Production Compose Patterns**, where side effects, state hoisting, and lifecycle-aware collection become essential tools
> - **DOC 11 — Remote Communication**, where the data displayed by your Composables originates — from Retrofit calls through Repositories to ViewModel StateFlows
> - **DOC 16 — Testing Strategy**, where you'll test Compose screens using `ComposeTestRule` and verify ViewModel-UI integration
