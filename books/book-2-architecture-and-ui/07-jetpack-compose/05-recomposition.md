...
> **You'll see this in...**
> - **DOC 8 — Inside Compose Runtime**, where you'll learn the *mechanism* — how the Slot Table, Snapshot System, and Recomposition Algorithm make this work under the hood
> - **DOC 9 — Production Compose Patterns**, where controlling recomposition scope and cost becomes a daily concern — `derivedStateOf`, `key()`, and stable types all exist to manage recomposition
> - **DOC 17 — Performance & Optimization**, where unnecessary recomposition is the most common Compose performance problem you'll debug
