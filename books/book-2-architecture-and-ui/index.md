...
This book teaches how to structure Android applications and build modern user interfaces with Compose.

**Assumes:** Book 1 knowledge (coroutines, flows, state management)
...
- ✅ Know how to design navigation
- ✅ Be able to build production Compose UIs
- ✅ Understand Compose internals and performance
- ✅ Know how to scale UI code across teams

---

**After Book 2:** [Book 3 — Production Systems](../book-3-production-systems/index.md)
