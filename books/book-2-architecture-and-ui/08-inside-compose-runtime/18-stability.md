...
> **You'll see this in...**
> - **DOC 9 — Production Compose Patterns**, where `@Immutable` and `@Stable` annotations are used to help Compose skip recomposition in performance-critical screens
> - **DOC 17 — Performance & Optimization**, where stability is one of the first things to check when diagnosing excessive recomposition — unstable parameters are the #1 cause of Compose jank
